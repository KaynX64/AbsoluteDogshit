package com.university.health.model
 ...
 * 
 * Multiplatform Note: This enum is shared across PC, Android, and Web platforms.
 */
@Serializable
enum class UserRole {
 ...
 * Multiplatform Note: This data class is serializable for cross-platform data exchange.
 */
@Serializable
data class User(
    val id: String,
 ...
 * 
 * Multiplatform Note: Shared across all platforms for consistent health profile display.
 */
@Serializable
 ...
 * 
 * Multiplatform Note: Shared across all platforms for consistent staff profile display.
 */
@Serializable
 ...
 * 
 * Multiplatform Note: Used for appointment scheduling on all platforms.
 */
@Serializable
 ...
 * 
 * Multiplatform Note: Determines UI behavior on each platform.
 */
@Serializable
 ...
 * 
 * Multiplatform Note: Used for status indicators across all platforms.
 */
@Serializable
 ...
 * 
 * Multiplatform Note: Core EMR data structure shared across all platforms.
 */
@Serializable
 ...
 * 
 * Multiplatform Note: Displayed consistently on all device types.
 */
@Serializable
 ...
 * 
 * Multiplatform Note: Viewable and downloadable on all platforms.
 */
@Serializable
 ...
 * 
 * Multiplatform Note: Can be downloaded as PDF on all platforms.
 */
@Serializable
 ...
 * 
 * Multiplatform Note: Used for filtering clearances on all platforms.
 */
@Serializable
 ...
 * 
 * Multiplatform Note: Accessed by dentists on all platforms.
 */
@Serializable
 ...
 * 
 * Multiplatform Note: Managed by nurses on all platforms.
 */
@Serializable
 ...
 * 
 * Multiplatform Note: Used for categorization and filtering on all platforms.
 */
@Serializable
 ...
 * 
 * Multiplatform Note: Critical for mobile devices where SOS is most likely to be used.
 */
@Serializable
data class SOSAlert(
    val id: String,
 ...
 * 
 * Multiplatform Note: On mobile, uses GPS; on desktop, uses IP-based location.
 */
@Serializable
data class Location(
    val latitude: Double,
 ...
 * 
 * Multiplatform Note: Used for emergency response prioritization.
 */
@Serializable
 ...
 * 
 * Multiplatform Note: Real-time updates on all platforms.
 */
@Serializable
 ...
 * 
 * Multiplatform Note: Affects queue ordering on all platforms.
 */
@Serializable
 ...
 * 
 * Multiplatform Note: Updated in real-time across all platforms.
 */
@Serializable
 ...
 * 
 * Multiplatform Note: Critical for emergency prioritization.
 */
@Serializable
 ...
 * 
 * Multiplatform Note: Logs actions from all platforms for compliance.
 */
@Serializable
data class AuditLog(
    val id: String,
    ...
    val details: String?,
    val platform: String? = null // Identifies if action came from PC, Android, or Web
)
